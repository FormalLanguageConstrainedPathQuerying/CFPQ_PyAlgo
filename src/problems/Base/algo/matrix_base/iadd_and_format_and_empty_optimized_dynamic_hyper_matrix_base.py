...
class IAddAndFormatAndEmptyOptimizedDynamicHyperMatrixBaseAlgo(AbstractDynamicHyperMatrixBaseAlgo):
    def non_hyper_enhance_matrix(self, base_matrix: EnhancedMatrix, var_name: str) -> EnhancedMatrix:
        return FormatOptimizedMatrix(
            ...
            base=IAddOptimizedMatrix(ShortCircuitingForEmptyMatrix(base_matrix))
        )
