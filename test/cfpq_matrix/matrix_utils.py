...
from cfpq_matrix.matrix_utils import decompose


def test_decompose_similar_rows_matrix():
    nrows, ncols = 15, 15
...
def test_decompose_multiple_patterns():
    nrows, ncols = 300, 100
    M = Matrix(BOOL, nrows=nrows, ncols=ncols)
...
def test_decompose_double_thresholding():
    nrows, ncols = 100, 50
    M = Matrix(BOOL, nrows=nrows, ncols=ncols)
...
def test_decompose_similar_columns_without_transpose():
    nrows, ncols = 100, 200
...
def test_decompose_random_matrix_with_patterns():
    nrows, ncols = 500, 500
    M = Matrix(BOOL, nrows=nrows, ncols=ncols)
